...
# root.title('GetProjects - Speech to Text')

# # Heading
# tk.Label(root, text='SPEECH TO TEXT', font='Helvetica 25 bold', bg='#2c3e50', fg='#ecf0f1').pack(pady=20)
...
#             text = recognizer.recognize_google(audio, language='ar')  # Arabic support
